...
El mensaje de cada commit normal identifica el archivo o carpeta de primer nivel
modificado (por ejemplo, `README.md`, `docs` o `.github`; varios elementos se
separan por coma). GitHub continúa mostrando además su propio tiempo relativo
junto a cada archivo. La guía completa y la activación de los hooks
